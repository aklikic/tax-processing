...
public class TransactionBatchWindowControllerWorkflowPostgreSQLIntegrationTest extends TestKitSupport {
    ...
    public void shouldProcessSmallBatchWithPostgreSQL() throws Exception {
        ...
        var startCommand = new TransactionBatchWindowControllerWorkflow.StartBatchCommand(batchId, taxYear);
        ...
        Awaitility.await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(status.status()).isEqualTo(
                    TransactionBatchWindowControllerState.ProcessingStatus.COMPLETED
                );
                assertThat(status.totalTransactions()).isEqualTo(3);
                assertThat(status.windowCount()).isEqualTo(2); // 3 transactions with window size 2 = 2 window
    ...
    public void shouldHandleEmptyDatabaseGracefully() throws Exception {
        ...
        Awaitility.await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(status.totalTransactions()).isEqualTo(0);
                assertThat(status.windowCount()).isEqualTo(0);
            });
    }
    ...
    public void shouldProcessMultipleWindowsWithPostgreSQL() throws Exception {
        ...
        Awaitility.await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(status.totalTransactions()).isEqualTo(5);
                assertThat(status.windowCount()).isEqualTo(3); // 5 transactions with window size 2 = 3 windows
            });
